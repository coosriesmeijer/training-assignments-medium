...
public class EddaASGJanitorCrawler implements JanitorCrawler {
	...
	private Resource parseJsonElementToresource(String region, JsonNode jsonNode,
		...
		addInstancesAndELBS(jsonNode, resource, lcNameToCreationTime);
	...
	private void addInstancesAndELBS(JsonNode jsonNode, Resource resource, Map<String, Long> lcNameToCreationTime) {
